...
public class RMath {
     ...
     */
    public static double angle(double rowCenter, double colCenter, double pixelRow, double pixelCol) {
     ...
     */
    public static double center(int dimension) {
        return ((double)dimension - 1.0) / 2.0;
    }
    /**
     * Convert a grid coordinate to a polar coordinate.
     */
    public static PolarCoordinate convert(double rowCenter, double colCenter, GridCoordinate gc) {
     ...
     */
    public static GridCoordinate convert(double rowCenter, double colCenter, PolarCoordinate pc) {
     ...
     */
    public static double distance(double rowCenter, double colCenter, double pixelRow, double pixelCol) {
        double a = (rowCenter - pixelRow);
        double b = (colCenter - pixelCol);
        double a2 = a * a;
        double b2 = b * b;
     ...
     */
    public static double getScale(int source, int target) {
        return (double)target / (double)source;
    }
    /**
     * Map an index in 1.0 scale to an index in the provided scale.
     */
    public static int map(int source, double scale) {
